function init(){
    ...
    function changeDots(dot){
        ...
        // add class 'active' on dot(slide) click
    ...
    function nextSlide(pageNumber){
        ...
        // add a starting value and an ending value
        tl.fromTo(currentLeft, 0.3, {y: '-10%'}, {y: '-100%'})
          ...
          .fromTo(nextText, 0.3, {opacity: 0, y: 30}, {opacity: 1, y: 0}, '-=0.4')
    ...
    // to make scrolling work on mobile
